const {getNodeStatus} = require("../../database/tables/nodeStatusLogger");
const {getNodeMeta} = require("../../database/tables/nodeMetaLogger");
const {getMonitorLogsByStatus} = require("../../database/tables/monitorLogger");

async function generateRSS() {
    const nodeStatusData = await getNodeStatus();
    const nodeMetaData = await getNodeMeta();
    const monitorData = await getMonitorLogsByStatus("ok");
